...
//credit to this guy for speeding things up a little: http://www.hanselman.com/blog/PerformanceOfSystemIOPortsVersusUnmanagedSerialPortCode.aspx
namespace UnmanagedPorts
{
    public class UnmanagedSerialPort : SerialPort
    {
        IntPtr portHandle;
        DCB dcb = new DCB();
